...
# Probably don't need all of this since the production comes mostly from B decays
...
def getAverageMesonRate(mumPdg):
    if (mumPdg==111): return 6.166		#pi0
    if (mumPdg==221): return 0.7012		#eta
    if (mumPdg==223): return 0.8295		#omega
    if (mumPdg==331): return 0.07825		#eta'
